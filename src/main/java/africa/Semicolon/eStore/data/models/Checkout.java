...
public class Checkout {
    ...
    private static void validateQuantitySelected(ShoppingCart cart) {
        for (Item item : cart.view()) Inventory.validateQuantityOf(item.getProduct(), item.getQuantityOfProduct());
    }
}
